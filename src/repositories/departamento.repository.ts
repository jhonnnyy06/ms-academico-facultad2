...
> {
  ...
  public readonly tiene: BelongsToAccessor<Facultad, typeof Departamento.prototype.id>;
  ...
  constructor(
    ...
    this.tiene = this.createBelongsToAccessorFor('tiene', facultadRepositoryGetter,);
